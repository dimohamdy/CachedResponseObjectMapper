 ...
 */
public class DLHamburguerViewController: UIViewController {
    ...
    public var _contentViewController: UIViewController!
    ...
    public var _menuViewController: UIViewController!
 ...
 public func showMenuViewController() { self.showMenuViewControllerAnimated(true, completion: nil) }
    ...
    public func hideMenuViewControllerWithCompletion(completion: ((Void) -> Void)?) {
    ...
    override public func shouldAutorotate() -> Bool { return self.contentViewController.shouldAutorotate() }
